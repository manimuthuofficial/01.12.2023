                 ...
                 <div class="row">
                    ...
                    <div class="col s12 m6 l6 right-align-md">
                        <ol class="breadcrumbs mb-0">
                            ...
                            <li class="breadcrumb-item active"><?php echo _l('Mail Box  <span style="color:#bdbaba;font-size:17px">- Sent Items</span>'); ?></li>
                        </ol>
                    </div>
                </div>
            </div>
						  ...
						  <div class="card card card-default scrollspy border-radius-6 fixed-width">
							...
							<div class="collection email-collection" id="messageContent">
								...
								<div class="email-brief-info collection-item">
									...
									<a class="list-content modal-trigger" href="<?php echo admin_url('communications/viewSentEmail/' . $sent_email['id']); ?>" >
										<div class="list-title-area">
											<div class="user-media">
												<div class="list-title">
												
													<p style="font-weight:normal;">From : <?php echo $sent_email['from']; ?> </p>
													
													<p style="font-weight:bold; color:#727272">To : <?php echo $sent_email['recipient']; ?> </p>
													...
													{
													?>
													<p style="font-weight:normal; color:#727272"><?php echo "Cc : ".$sent_email['cc']; ?> </p>
													<?php
													}
													?>
													...
													{
													?>
													<p style="font-weight:normal; color:#727272"><?php echo "Bcc : ".$sent_email['bcc']; ?> </p>
													<?php
													}
													?>
													...
													{
													?>
													<span><?php echo "No Subject"; ?></span>
													<?php
													}
													else
													{
													?>
													<span style="font-weight:bold"><?php echo $sent_email['subject']; ?></span>
													<?php
													}
													?>
...
<?php
									$attachments_folder = FCPATH . 'assets/attachments/' . $sent_email['id'];
									...
									?>											
										...
										<div class="list-desc">
											...
											<?php
											if(empty($sent_email['message']))
											{
											?>
											<span><?php echo "No Message to Display."; ?></span>
											<?php
											}
											else
											{
											?>
											<span style="font-weight:normal"><?php echo strip_tags($sent_email['message']); ?></span>
											<?php
											}
											?>
