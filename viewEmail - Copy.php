										...
										<div class="" style="background-color:#f9f9f9;margin-top:30px;padding:5px 25px;">
											...
											<div class="email-content">
												...
												<div class="email-desc">												
													<?php 
													 if (!empty($email_data['body']['html']))
													 {	
													 ?>														
														<?= $email_data['body']['html']; ?><br>
													<?php 
													 }
													 else
													 {
								  ...
								  <div class="email-footer">									
									...
									<div class="reply-box d-none">
									  ...
									  <?php echo form_open_multipart('class="edit-email-item mt-10 mb-10" id="emailForm"'); ?>
										...
										<div class="s12" style="padding-bottom:7px;">
											<div class="input-field">
												<input placeholder="Subject" type="text" id="subject" name="subject" value="<?php echo $subject; ?>">
													...
													$.ajax({
														...
														success: function(response) 
														{
															...
															$("#successModalBtn").click(function () {
															  //location.reload();
															  window.location.href = "<?php echo admin_url('Communications/dashboard'); ?>";
															});
														...
														error: function(xhr, status, error) 
														{
															...
															$("#errorModalMessage").text("Email sending failed.");
															$("#errorModal").modal("open");
