								...
								<ul class="email-list display-grid" id="messageTabs">
									...
									<li <?php if ($this->input->get('tab') === 'sent') echo 'class="active"'; ?>>
										<a  href="<?= admin_url('communications/dashboard?tab=sent') ?>" class="text-sub">
											<i class="material-icons mr-2"> send </i> Sent Items
										</a>
									</li>
					...
					<div class="app-email-content">
					  <div class="content-area content-right">
						<div class="app-wrapper">
						  <h4 style="font-family: 'Questrial', sans-serif;font-size:20px;text-transform:uppercase;font-weight:bold">Correspondence Details</h4>		
							  ...
							  <div class="row">
								<div class="col s12">
									...
									<div class="conversation">
										...
										<?php foreach ($communication['reply_messages'] as $message): ?>
										
											<?php if ($message['from_email'] === $communication['from_email']) : ?>
																							
												<div class="" style="background-color:#f9f9f9;margin-top:30px;padding:5px 25px;">
													<!-- Email Header -->
													<div class="email-header">
														<div class="subject">									  
														  <div class="email-title"><?php echo $message['subject']; ?></div>
														</div>
													</div>
													<!-- Email Header Ends -->
														...
														<div class="list-title-area">
														  <div class="user-media">
															...
															<div class="list-title">
															  <span class="name"><a href="#">From : <?php echo $message['from_email']; ?> [ <?php echo $message['sender_name']; ?> ] - <?php echo $message['id']; ?></a></span>
															  
																<p style="font-weight:normal; color:#cbc7c7">To : <?php echo $message['to_email']; ?> - <?php echo $message['recipient_name']; ?> </p>
																<p style="font-weight:normal; color:#cbc7c7">CC : <?php echo $message['cc_emails']; ?></p>
														  ...
														  <div class="title-right">
															<span class="mail-time"><?php echo $created_at; ?></span>										
														  </div>
														</div>
											...
											<?php else: ?>
												<div class="" style="border: 1px solid #e2e2e5;;margin-top:30px;padding:5px 25px;border-radius:4px;">
													<!-- Email Header -->
													<div class="email-header">
														<div class="subject">									  
														  <div class="email-title"><?php echo "Re : ".$message['subject']; ?></div>
														</div>
													</div>
													<!-- Email Header Ends -->
													...
													<div class="email-content">
														<div class="list-title-area">
														  <div class="user-media">
															...
															<div class="list-title">
															  <!--
															  <span class="name"><a href="#"><?php //echo $message['from_email']; ?> [ <?php //echo $message['sender_name']; ?> ] - <?php //echo $message['id']; ?></a></span>
															  -->
									  ...
									  <?php echo form_open('class="edit-email-item mt-10 mb-10" id="reply-email-form"'); ?>
										...
										<div class="row">		
											<div class="input-field col s12">
												<input type="text" id="reply_message_id" name="reply_message_id" value="<?php echo $communication['id']; ?>" >
												<label for="">Reply Message ID</label>
											</div>
										</div>
									
										<div class="row">		
											<div class="input-field col s12">
												<input type="text" id="reply_thread_id" name="reply_thread_id" value="<?php echo $communication['thread_id']; ?>" >
												<label for="">Reply Thread ID</label>
											</div>
										</div>
				
										<div class="row">		
											<div class="input-field col s12">
												<input type="text" id="reply_from_email" name="reply_from_email" value="<?php echo $session_email." - ".$firstname." ".$lastname; ?>" >
												<label for="">Reply From Email</label>
											</div>
										...
										<div class="row">		
											<div class="input-field col s12">
												<input type="text" id="reply_to_email" name="reply_to_email" value="<?php echo $communication['from_email']; ?> - <?php echo $communication['sender_name']; ?>">
										...
										<div class="row">											
											<div class="input-field col s12">
												<input type="text" id="reply_subject" name="reply_subject" value="<?php echo $communication['subject']; ?>" >
										...
										<?php
										$cc_emails = explode(',', $communication['cc_emails']);
										
										$filtered_cc_emails = array(); 
										
										foreach ($cc_emails as $cc_email) 
										{
											$cc_email = trim($cc_email); // Remove any leading/trailing whitespace
											
											if ($cc_email !== $session_email) 
											{
												$filtered_cc_emails[] = $cc_email; // Add the email address to the filtered array if it's not equal to the session email
											}
										}
										
										$filtered_cc_email_string = implode(', ', $filtered_cc_emails); 
										...
										<div class="row">		
											<div class="input-field col s12">
												<input type="text" id="reply_cc_emails" name="reply_cc_emails" value="<?php echo $filtered_cc_email_string; ?>, <?php echo $communication['to_email']; ?>">
												<label for="">Reply CC Emails</label>
											</div>
										...
										<div class="row">
											<label style="padding-left: 18px;font-size:16px;color:#000">Reply Message</label>
											<div class="input-field  col s12">												
		...
		<?php echo form_open('class="edit-email-item mt-10 mb-10" id="email-form"'); ?>
			...
			<div class="input-field col s12" style="padding-bottom:20px;">
				<select id="cc_emails[]" name="cc_emails[]" class="select2-customize-result browser-default" multiple="multiple" id="select2-customize-result">
					...
					<option value="<?php echo $cc_admin_email['email']; ?>"> <?php echo $cc_admin_email['email']; ?> - <?php echo $cc_admin_email['firstname']; ?> <?php echo $cc_admin_email['lastname']; ?> </option>
...
$(document).ready(function() {
	...
	$("#reply-btn").click(function(event) {
		...
		var reply_thread_id = $("#reply_thread_id").val();
		...
		if (reply_message_id.trim() === "") {
			// Display a validation error message
			//displayErrorAlert("Error : Please reload the page.");
			//$("#reply_message_id").focus();
			location.reload();
			return;
		}
		
		if (reply_thread_id.trim() === "") {
			// Display a validation error message
			//displayErrorAlert("Error : Please reload the page.");
			//$("#reply_thread_id").focus();
			location.reload();
			return;
		}
							...
							<div class="row">
								...
								<div class="email-content">
									...
									<div class="user-media">
										...
										class="circle z-depth-2 responsive-img avtar">
										<div class="list-title">
										<span class="to-person">To</span>
										<span class="name"><a href="#" id="modalToEmail1"></a></span>										
										</div>
									</div>
									<div class="title-right">
