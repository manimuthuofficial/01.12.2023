										...
										<?php foreach ($communications as $communication): ?>
											...
											<div class="" style="background-color:#f9f9f9;margin-top:30px;padding:5px 25px;">
												...
												<div class="email-header">
													<div class="subject">
													  <?php
													  if($communication['is_reply'] == 0)
													  {
													  ?>
													  <div class="email-title"><?php echo $communication['subject']; ?></div>
													  <?php
													  }
													  else if($communication['is_reply'] == 1)
													  {
													  ?>
													  <div class="email-title"><?php echo "Re. ".$communication['subject']; ?></div>
													  <?php
													  }
													  else
													  {
													...
													<div class="list-title-area">
													  <div class="user-media">
														...
														<div class="list-title">
														  <span class="name"><b><?php echo $communication['from_email']; ?> [ <?php echo $communication['sender_name']; ?> ] - <?php echo $communication['id']; ?></b></span>
														  
															<p style="font-weight:normal; color:#727272">To : <?php echo $communication['to_email']; ?> - <?php echo $communication['recipient_name']; ?> </p>
															<p style="font-weight:normal; color:#727272">CC : <?php echo $communication['cc_emails']; ?></p>
								  ...
								  <div class="email-footer">									
									...
									<div class="reply-box d-none">
									  ...
									  <?php echo form_open('class="edit-email-item mt-10 mb-10" id="reply-email-form"'); ?>
										...
										<?php 
										foreach ($from_email_by_thread_id_is_reply as $reply_to_email): 
										?>										
										<div class="row">		
											<div class="input-field col s12">
												<input type="text" id="reply_to_email" name="reply_to_email" value="<?php echo $reply_to_email['from_email']; ?> - <?php echo $reply_to_email['sender_name']; ?>">
										...
										<?php 
										foreach ($from_email_by_thread_id_is_reply as $also_reply_to_email): 
																				
										$also_reply_to_email = $also_reply_to_email['to_email'];
										
										endforeach; 
										?>
										
										<?php 
										foreach ($from_email_by_thread_id_is_reply as $cc_emails): 
										...
										<div class="row">		
											<div class="input-field col s12">
												<input type="text" id="reply_cc_emails" name="reply_cc_emails" value="<?php echo $filtered_cc_email_string.", ". $also_reply_to_email; ?>">
